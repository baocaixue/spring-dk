...
public class PlainSingerDao implements SingerDao {
    ...
    static {
        try {
            ...
            logger.error("Problem happen when load jdbc Driver! " , e.getMessage());
        }
    }

    private Connection getConnection() throws SQLException{
        return DriverManager.getConnection("jdbc:mysql://localhost:3306/musicdb?useSSL=false&allowPublicKeyRetrieval=true", "isaac", "isaac");
    }
    ...
    private void closeConnection(Connection connection) {
        ...
        try {
            ...
            logger.error("Problem closing connection to the database!", ex.getMessage());
        }
    }
